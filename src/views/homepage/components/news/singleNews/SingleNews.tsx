...
export const SingleNews = ({
	...
	return (
		<div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-7 bg-navbar rounded-lg shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] h-full  lg:h-[350px] w-full">
			...
			<h5 className="px-4 py-4 row-start-1 row-end-3 lg:col-start-2 lg:row-start-1 lg:row-end-3 bg-primary text-white lg:bg-white lg:text-primary font-semibold text-2xl lg:text-2xl flex items-center">
				{title}
			</h5>
			<div className="px-4 py-3 row-start-4 row-end-5 lg:col-start-2 lg:row-start-3 lg:row-end-7 lg:overflow-y-scroll">
				{children}
			</div>
			<div className="col-start-1 row-start-5 row-end-6 flex w-full lg:px-4 lg:col-start-2 lg:row-start-8 lg:grid lg:items-end pb-4">
				<a
					href={pathToFile}
					target="_blank"
