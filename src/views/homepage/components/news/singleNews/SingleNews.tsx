...
export const SingleNews = ({
	...
	return (
		<div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-5 bg-navbar rounded-lg shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] h-full  lg:h-[400px] w-full">
